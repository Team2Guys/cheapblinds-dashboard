  ...
  return (
    <Show isLoading={isLoading}>
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={6}>
          <Typography variant="body1" fontWeight="bold">Short Description</Typography>
          <TextField value={record?.shortDescription} />
        </Grid>

        <Grid item xs={12} sm={6}>
          <Typography variant="body1" fontWeight="bold">Custom URL</Typography>
          <TextField value={record?.customUrl} />
        </Grid>

        <Grid item xs={12} sm={6}>
          <Typography variant="body1" fontWeight="bold">Meta Title</Typography>
          <TextField value={record?.metaTitle} />
        </Grid>

        <Grid item xs={12} sm={6}>
          <Typography variant="body1" fontWeight="bold">Meta Description</Typography>
          <TextField value={record?.metaDescription} />
        </Grid>

        <Grid item xs={12} sm={6}>
          <Typography variant="body1" fontWeight="bold">Canonical Tag</Typography>
          <TextField value={record?.canonicalTag} />
        </Grid>

        <Grid item xs={12} sm={6}>
          <Typography variant="body1" fontWeight="bold">Breadcrumb</Typography>
          <TextField value={record?.breadCrumb} />
        </Grid>

        <Grid item xs={12} sm={6}>
          <Typography variant="body1" fontWeight="bold">Thumbnail URL</Typography>
          <TextField value={record?.thumbnailUrl} />
        </Grid>

        <Grid item xs={12} sm={6}>
          <Typography variant="body1" fontWeight="bold">Last Edited By</Typography>
          <TextField value={record?.lastEditedBy} />
        </Grid>

        <Grid item xs={12}>
          <Typography variant="body1" fontWeight="bold">SEO Schema</Typography>
        ...
        <Grid item xs={12} sm={6}>
          <Typography variant="body1" fontWeight="bold">Discount Price</Typography>
